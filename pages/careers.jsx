...
const processSteps = [
  {
    title: "Apply",
    description:
      "Submit your profile with portfolio links and relevant project experience.",
  },
  {
    title: "Review",
    description:
      "Our team reviews fit, craft quality, and alignment with current roles.",
  },
  {
    title: "Interview",
    description:
      "A focused conversation on work style, thinking process, and collaboration.",
  },
  {
    title: "Offer",
    description:
      "You receive a clear offer, role charter, and onboarding roadmap.",
  },
];
  ...
  return (
    <>
      ...
      <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
        ...
        <section
          className="relative isolate overflow-hidden border-b border-white/10 px-6 pb-20 pt-28 md:pb-24 md:pt-36 min-h-[65vh] md:min-h-[75vh] bg-cover bg-center bg-no-repeat"
          style={{
            backgroundImage:
              "url('https://pub-7b63f90a5dc84c2eb2eb99e09a79f1bf.r2.dev/RasterBros%20Website/Internship-System/Background%20Images/Webp/3.webp')",
          }}
        >
          {/* Dark overlay */}
          ...
          <div className="container relative mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/70 md:text-lg">
              ...
              project. We build bold visual experiences with precision, speed,
              and intent.
            </p>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-white/65">
                We value clarity, proactive thinking, and collaborative
                execution. If you are obsessed with details and open to
                feedback, you will thrive here.
              </p>
            </div>
        ...
        <SectionWrapper
          id="open-roles"
          className="border-y border-white/10 bg-gradient-to-b from-white/[0.02] to-transparent"
        >
          <Heading
            eyebrow="Open Roles"
